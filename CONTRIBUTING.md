# Contributing to koa-better-serve

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `koa-better-serve`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `koa-better-serve` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/koa-better-serve/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
The [`question` label](https://github.com/tunnckoCore/koa-better-serve/labels/question) is a good place to find ongoing discussions.
...
1. **version**: what version of `koa-better-serve` were you using when you experienced the bug?
